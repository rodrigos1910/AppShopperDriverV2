...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class PowermockLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public PowermockLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>powermock</b> with <b>org.powermock:powermock-module-junit4</b> coordinates and
         * with version reference <b>powermock.module</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("powermock");
        }

        /**
         * Dependency provider for <b>api</b> with <b>org.powermock:powermock-api-mockito2</b> coordinates and
         * with version reference <b>powermock.api</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getApi() {
            return create("powermock.api");
        }
    ...
    public static class PowermockVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>powermock.api</b> with value <b>2.0.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getApi() { return getVersion("powermock.api"); }

        /**
         * Version alias <b>powermock.module</b> with value <b>2.0.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getModule() { return getVersion("powermock.module"); }
